<template>
  <div class="wrapper">
    <Parallax class="page-header header-filter" :style="image != '' ? `background-image: url(${image})` : `background-image: url(${require('@/assets/img/vue-mk-header.jpg')})`">
      <div class="md-layout">
        <div class="md-layout-item">
          <div class="image-wrapper">
            <img :src="require('@/assets/img/leaf4.png')" alt="leaf4" class="leaf4" v-show="leafShow" />
            <img :src="require('@/assets/img/leaf3.png')" alt="leaf3" class="leaf3" v-show="leafShow" />
    ...
    <div class="main main-raised">
      ...
      <div class="section section-signup page-header" :style="signup != '' ? `background-image: url(${signup})` : `background-image: url(${require('@/assets/img/city.jpg')})`">
        <div class="container">
          <div class="md-layout">
            <div
      ...
      <div class="md-layout">
        <div class="md-layout-item text-center">
          <NuxtLink to="/Login">
            <md-button class="md-simple md-success md-lg"
